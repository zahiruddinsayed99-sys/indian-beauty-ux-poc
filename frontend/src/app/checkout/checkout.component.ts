...
@Component({
  ...
  template: `
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
      ...
      <div class="md:w-2/3">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md mb-6">
          ...
          <form #checkoutForm="ngForm" class="space-y-4">
            <div>
              <input type="email" name="email" [(ngModel)]="email" required email #emailCtrl="ngModel" placeholder="Email for Order Updates" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 focus:ring-2 focus:ring-primary-500 outline-none" [ngClass]="{'border-red-500': emailCtrl.invalid && emailCtrl.touched}">
              <p *ngIf="emailCtrl.invalid && emailCtrl.touched" class="text-red-500 text-xs mt-1">Please enter a valid email address.</p>
            </div>
            <div class="flex gap-4">
              <div class="w-1/2">
                <input type="text" name="pincode" [(ngModel)]="defaults.address_defaults.pincode" required pattern="[0-9]{6}" #pincodeCtrl="ngModel" placeholder="Pincode (6 digits)" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary-500" [ngClass]="{'border-red-500': pincodeCtrl.invalid && pincodeCtrl.touched}">
                <p *ngIf="pincodeCtrl.invalid && pincodeCtrl.touched" class="text-red-500 text-xs mt-1">Enter valid 6-digit Pincode.</p>
              </div>
              <div class="w-1/2">
                <input type="text" name="city" [(ngModel)]="defaults.address_defaults.city" required #cityCtrl="ngModel" placeholder="City" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary-500" [ngClass]="{'border-red-500': cityCtrl.invalid && cityCtrl.touched}">
              </div>
            </div>
            <div class="flex gap-4">
              <div class="w-1/2">
                <input type="text" name="state" [(ngModel)]="defaults.address_defaults.state" required #stateCtrl="ngModel" placeholder="State" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary-500" [ngClass]="{'border-red-500': stateCtrl.invalid && stateCtrl.touched}">
              </div>
              <div class="w-1/2">
                <input type="text" name="street" [(ngModel)]="defaults.address_defaults.street" required #streetCtrl="ngModel" placeholder="Street Address" class="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-3 outline-none focus:ring-2 focus:ring-primary-500" [ngClass]="{'border-red-500': streetCtrl.invalid && streetCtrl.touched}">
              </div>
            </div>

            <label class="flex items-center gap-2 font-medium text-gray-700 dark:text-gray-300 cursor-pointer mt-4">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
          ...
          <div class="space-y-3">
            <label class="flex items-center justify-between p-4 border border-primary-500 rounded-lg cursor-pointer bg-primary-50">
              <div class="flex items-center gap-3">
                <input type="radio" name="payment" [value]="'UPI / GPay'" [(ngModel)]="defaults.payment_preference" class="w-5 h-5 text-primary-600">
                <span class="font-bold">UPI / GPay</span>
              </div>
              <span class="bg-primary-200 text-primary-800 text-xs font-bold px-2 py-1 rounded">Recommended</span>
            </label>
            <label class="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:bg-gray-900">
              <div class="flex items-center gap-3">
      ...
      <!-- Order Summary -->
      <div class="md:w-1/3">
        <div class="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 sticky top-4">
          ...
          <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4 mb-6 text-sm">
          ...
          <div class="flex justify-between items-center text-xl font-bold border-t border-gray-300 dark:border-gray-600 pt-4 mb-6">
    ...
    <div *ngIf="showModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-sm w-full overflow-hidden flex flex-col">
        ...
        <div class="p-6 text-center">
          ...
          <div class="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg mb-6 flex items-center justify-between">
